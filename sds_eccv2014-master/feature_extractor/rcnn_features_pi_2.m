function feat = rcnn_features_mask(im, masks, boxes, rcnn_model)
...
% tic;
[batches, masked_batches, batch_padding] = rcnn_extract_regions_mask_2(im, masks, boxes, rcnn_model);
% t=toc;
% fprintf('[done, %f s]\n', t);
...
%   f = caffe('forward', B);
  f = rcnn_model.cnn.net.forward(B);
  f = f{1};
